...
//	scope				varchar2(100),				
//	created_at			number(30),						
//	created_rt			number(30),						
...
public class TokenVO {
	...
	public TokenVO(String client_id, String access_token,
	...
	public String toString() {
		return "TokenVO [client_id=" + client_id + ", access_token=" + access_token + ", refresh_token="
				+ refresh_token + ", token_type=" + token_type + ", scope="
				+ scope + ", code=" + code + ", client_type=" + client_type + ", created_at=" + created_at
