...
public class Constants {
	...
	public static final String CLIENT_ID="TPDDL";
...
//sumit start: Camera Orientation Feature
	...
	public static final String TPDDL = "TPDDL";
	
	public static final String ZwaveAc="ZwaveAc";
	public static final String ACTIVITY_TRIGGER="ACTIVITY_TRIGGER";
	public static final String ViaUnit="ViaUnit";
	public static final String VIA_UNIT="VIA_UNIT";
	public static final String EflCONTROLLER_PORT = "eflcontrollerport";
	public static final Object TVOn = null;
	public static final String TVOnOff = "TVOnOff";
