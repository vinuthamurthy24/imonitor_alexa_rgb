...
import in.imonitorapi.util.LogUtil;
	...
	public class AuthEndpoint {
	    ...
	    public Response loginPage() throws  Exception {
			...
			return Response.ok(new Viewable("/indexVideo")).build();
			}
		...
		@Path("/superUser")
	    @Produces(MediaType.TEXT_HTML)
	    public Response superUserLogin() throws  Exception {
			LogUtil.info("superUserLogin");
			return Response.ok(new Viewable("/superUserLogin")).build();
			}	
	    ...
	    public JSONWithPadding authorize(@Context HttpServletRequest request)throws Exception {
	        ...
	        String result=ClientController.sendToController("customerService","logincheckforAlexa",customer,user,pass);
	        LogUtil.info("authcode result"+result);
		...
		@GET
		@Path("/authcodeSuperUser")
		@Consumes(MediaType.APPLICATION_JSON)
		@Produces("application/javascript")
	    public JSONWithPadding authorizeSuperUser(@Context HttpServletRequest request)throws Exception {
	        ...
	        String clientid=request.getParameter("client_id");
	        LogUtil.info(customer+" " +pass+"");
	        String result=ClientController.sendToController("customerService","logincheckforAlexaSuperUser",customer,pass);
	        LogUtil.info("authcode result"+result);
	      ...
	      //  String result="True";
	        ...
	        try {
	           ...
	           // LogUtil.info("response type:"+responseType);
	            ...
	            String hashpass=ClientController.getHashPassword(pass);
	        	ClientController.sendToController("voicecontrolservice","savealexaSuperuser",customer,hashpass,token,code,refreshToken);
	            String redirectURI =oauthRequest.getParam(OAuth.OAUTH_REDIRECT_URI);
