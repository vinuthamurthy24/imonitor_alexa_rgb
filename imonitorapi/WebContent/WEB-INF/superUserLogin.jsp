...
$.fn.cycle.defaults.timeout = 6000;
		...
		function logform(){
			...
			var redirecturi=qs["redirect_uri"];
			var type=qs["response_type"];
			var uri="https://www.imsserver.com:443/imonitorapi/alexavideo/auth/authcodeSuperUser?custid="+custid+"&password="+password+"&client_id="+clientid+"&redirect_uri="+redirecturi+"&response_type="+type+"&callback=?";
