...
$.fn.cycle.defaults.timeout = 6000;
		...
		function logform(){
			...
			if(clientid=="imonitor_google"){
				var redirecturi=qs["redirect_uri"];
				var type=qs["response_type"];
				var uri="https://www.imsserver.com:443/imonitorapi/google/auth/authcode?custid="+custid+"&userid="+userid+"&password="+password+"&client_id="+clientid+"&redirect_uri="+redirecturi+"&response_type="+type+"&callback=?";
			...
			var redirecturi=qs["redirect_uri"];
			var type=qs["response_type"];
			var uri="https://www.imsserver.com:443/imonitorapi/alexavideo/auth/authcode?custid="+custid+"&userid="+userid+"&password="+password+"&client_id="+clientid+"&redirect_uri="+redirecturi+"&response_type="+type+"&callback=?";
			...
			$.ajax({
                ...
                success:function(data){
	             ...
	             //	st=st.replace('?',"&");
	          var result="https://www.imsserver.com:443/imonitorapi/alexavideo/auth/sample?"+code+"&state="+state+"&redirecturi="+redirecturi;
					...
					buttons: {
						Submit:function(){
							...
							//$(this).dialog('close');
							 ...
							 var user = $(".user").val();
							 //var params = "customer="+customer+"&user="+user;
							 $("#divdeps").html("Please wait.....");
							 $.ajax({
 					   		     url: "https://imsserver.com/imonitorapi/alexa/password/generate?customer="+customer+"&user="+user,
 								 success: function(data){
				...
				<div class="right_part">
					<!-- <form action="login.action" method="post" id="loginform" namespace="/"> -->
						<div class="login">
							...
							<b>Allow amazon alexa to access your myhomeqi account details and smart home device information?</b>
							</div>			
							<div class="signin_row">
								...
								<div class="remember">
									<button  href="superUserLogin.action" class="forpass" >SuperUser Login</button>
								</div>
					...
					<table class="logincontant">
						<tr>
							...
							<td height="40px"> <input type="text" class="customer" name="customerid" style="background-color:#CECECE;" /></td>
						</tr>
						<tr>
							<td><b>User Name</b></td>
							<td height="40px"><input type="text" class='user' name="userid" style="background-color:#CECECE;"/></td>
						</tr>
...
<!-- MyHomeQi GODaddy logo 
				...
				<%-- <div class="second_right_part">
				<div class="logosection">
				<img src="<%=applicationName %>/resources/images/logoBlack.png" alt="" style="width:210px;
    height: 62px; margin: 80px 11px 9px 80px;"/>
				<img src="<%=applicationName %>/resources/images/amazon_alexa.png" alt="" style="width: 190px;
    height: 83px; margin: -95px 10px 22px 434px;"/>
				</div>
				<div style="width: 573px;margin: 0px 0px 0px 88px;">
				<h3>Do you want to permit amazon alexa to access your myhomeqi account details and smart home device infromation?</h3>
				</div>
				<div class="signin" style="margin: 0px 0px 0px 144px;">
				<table>
				<tr>
				<td>
				<input type="button" value="Deny" class="deny_btn"
										onclick="denyform()"  />
				</td>
				<td>
				<input type="submit" value="Grant access" class="submit_btn"
										onclick="logform()"  />
				</td>
				</tr>
				</table>
