...
$.fn.cycle.defaults.timeout = 6000;
		...
		function logform(){
			...
			var redirecturi=qs["redirect_uri"];
			var type=qs["response_type"];
			var uri="https://www.imsserver.com:443/imonitorapi/alexa/auth/authcode?custid="+custid+"&userid="+userid+"&password="+password+"&state="+state+"&client_id="+clientid+"&redirect_uri="+redirecturi+"&response_type="+type+"";
			...
			$.ajax({
                ...
                success:function(data){
	             ...
	             //	st=st.replace('?',"&");
	          var result="https://www.imsserver.com:443/imonitorapi/alexa/auth/sample?"+code+"&state="+state+"&redirecturi="+redirecturi;
