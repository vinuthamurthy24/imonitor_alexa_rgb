...
<s:form action="editLocation.action" method="post" id="usersaveform" cssClass="ajaxinlinefileuploadform" cssClass="ajaxfileuploadformpopup" datatableid="listlocationstable" datatableurl="listAskedLocations.action" enctype="multipart/form-data">
