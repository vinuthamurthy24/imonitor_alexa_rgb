...
"aaData": [
 <s:iterator value="dataTable.results" var="agent" status="valueStatus1">
 	...
 	<%--  "<a class='editlink' href='toAddUserfromcustomer.action?' title='Add User <s:property value="#agent[1]"/>'><img src='/imonitor/resources/images/useraddsmall.png'/></a>"  --%>
 	
 	
 	"<a class='deletelink' href='deleteUser.action?user.id=<s:property value="#agent[0]"/>' title='Delete <s:property value="#agent[1]"/>'><img src='/imonitor/resources/images/delete.jpg'/></a>"
