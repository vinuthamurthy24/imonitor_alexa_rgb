...
<s:form action="UpdateSystemIntegrator.action" method="post" id="SystemIntegratorForm"  enctype="multipart/form-data" cssClass="ajaxinlinefileuploadformWithDialog">
	<s:hidden name="systemIntegrator.id"></s:hidden>
	<s:hidden value="edit" name="action"></s:hidden>
	...
	<s:file name="fileUpload" label="Choose the Logo image file to upload"></s:file>
