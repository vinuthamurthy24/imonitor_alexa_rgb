...
"aaData": [
 <s:iterator value="dataTable.results" var="agent" status="valueStatus1">
 	...
 	"<a class='editlink' href='toEditAdminSuperUser.action?superuser.id=<s:property value="#agent[0]"/>' title='Edit <s:property value="#agent[1]"/>'><img src='/imonitor/resources/images/edit.jpg'/></a><a class='deletelink' href='deleteAdminSuperUser.action?superuser.id=<s:property value="#agent[0]"/>' title='Delete <s:property value="#agent[1]"/>'><img src='/imonitor/resources/images/delete.jpg'/></a>" 
