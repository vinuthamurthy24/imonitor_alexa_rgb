...
<s:form action="updateFriendlyNameAndLocationForSlave.action" theme="simple" method="post" cssClass="ajaxinlinepopupform" id="updatefriendlynameandlocationform">
        ...
        <s:hidden name="device.icon.fileName" id="currentIcon"></s:hidden>
       	...
       	<s:hidden name="device.deviceType.name" id="deviceTypeName"></s:hidden>
       	<s:hidden name="device.gateWay.id" id="gatewayId"></s:hidden>
       	<s:hidden name="device.generatedDeviceId" id="generatedDid"></s:hidden>
	...
	<s:if test='device.deviceType.name.equals("Z_WAVE_SWITCH") || device.deviceType.name.equals("Z_WAVE_DIMMER")' >
	<tr> <td><s:text name="setup.devices.edit.timeout" /></td> 
	...
	<td><s:radio theme="simple" list="#{'2':''}"  name="timeout"  cssClass="timeOut" /> <s:textfield id="showPulseTime" name='device.pulseTimeOut' label="Value" size="5" minvalue="0" maxvalue="60" value='0'></s:textfield> 
		</td>
