...
<s:hidden name="key7.action.actionName"> </s:hidden>
<s:hidden name="key7.device.id"> </s:hidden>
<s:hidden name="key7.keyCode"> </s:hidden>
<s:hidden name="key7.id"> </s:hidden>
<s:hidden name="key7.keyName"> </s:hidden>
<s:hidden name="key7.pressType"> </s:hidden>
<s:hidden name="key7.posindex"> </s:hidden>

<s:hidden name="key72.action.actionName"> </s:hidden>
<s:hidden name="key72.device.id"> </s:hidden>
<s:hidden name="key72.keyCode"> </s:hidden>
<s:hidden name="key72.id"> </s:hidden>
<s:hidden name="key72.keyName"> </s:hidden>
<s:hidden name="key72.pressType"> </s:hidden>
<s:hidden name="key72.posindex"> </s:hidden>

<s:hidden name="key8.action.actionName"> </s:hidden>
<s:hidden name="key8.device.id"> </s:hidden>
<s:hidden name="key8.keyCode"> </s:hidden>
<s:hidden name="key8.id"> </s:hidden>
<s:hidden name="key8.keyName"> </s:hidden>
<s:hidden name="key8.pressType"> </s:hidden>
<s:hidden name="key8.posindex"> </s:hidden>

<s:hidden name="key82.action.actionName"> </s:hidden>
<s:hidden name="key82.device.id"> </s:hidden>
<s:hidden name="key82.keyCode"> </s:hidden>
<s:hidden name="key82.id"> </s:hidden>
<s:hidden name="key82.keyName"> </s:hidden>
<s:hidden name="key82.pressType"> </s:hidden>
<s:hidden name="key82.posindex"> </s:hidden>
...
<tr>
<td Width="20px"><s:text name="key7.keyName"></s:text></td>
<td Width="120px"><s:select name="key7.action.id" list="actions" listKey="id" listValue="actionName" headerKey="0" headerValue="%{getText('setup.devices.action.select')}" ></s:select></td>
<td Width="120px"><s:select name="key72.action.id" list="actions" listKey="id" listValue="actionName" headerKey="0" headerValue="%{getText('setup.devices.action.select')}" ></s:select></td>
</tr>
<tr>
<td Width="20px"><s:text name="key8.keyName"></s:text></td>
<td Width="120px"><s:select name="key8.action.id" list="actions" listKey="id" listValue="actionName" headerKey="0" headerValue="%{getText('setup.devices.action.select')}" ></s:select></td>
<td Width="120px"><s:select name="key82.action.id" list="actions" listKey="id" listValue="actionName" headerKey="0" headerValue="%{getText('setup.devices.action.select')}" ></s:select></td>
</tr>
</tbody>
</table>
...
<script>
	...
	$(document).ready(function(){
		 ...
		 var rows = null;
		/*  <s:iterator  value="keyConfig" var="test" status="x">
		 
		 <s:if test='#test.pressType=="Single Click"'>
		 rows+= "<tr><th><s:property value="#test.keyName" /></th><th><select><option value='<s:property value="#test.id" />'><s:property value='#test.keyName'/></option></select></th></tr>";
			 $("#sceneConfigTable").append(rows);
			  </s:if>
