...
<div class="pageTitle">
	...
	<table>
		<tr>
		<s:hidden name="gateId" id="gateId"></s:hidden>
			<td id="ruleAdd" >
			...
			<td id="securityEdit">
				<a class='editlink rulenadd' href="toEditRuleSecurity.action" popupheight="500" popupwidth="750" popuptitle="<s:text name='setup.rules.mode.edit' />" 
				title="Edit Mode for Devices"><img  style="width:35px; height:35px;" src="/imonitor/resources/images/CustomWidgets.png"></a>
			</td><td>
				<a class='editlink rulenadd' href="toEditRuleSecurity.action" popupheight="500" popupwidth="750" popuptitle="<s:text name='Configure rule action' />" 
				title="Edit Mode for Devices"><span class='titlespangeneric'><s:text name='Configure rule action' /></span></a>
			</td> 
		</tr>
	</table>
