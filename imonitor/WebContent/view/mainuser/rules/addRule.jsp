...
<s:hidden name="gwayId" id="gwayId" ></s:hidden>
<span id="step1" >
...
<td>
<s:checkbox theme="simple"  name="alert" />
</td>
</tr>

<tr>
<td>
Send security actions to all gateways
</td>
<td>
<s:checkbox theme="simple"  name="securityAlert" />
</td>
</tr>
