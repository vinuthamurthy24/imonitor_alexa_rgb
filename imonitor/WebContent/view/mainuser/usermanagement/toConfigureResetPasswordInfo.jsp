...
<s:form name="resetPassConf" id="configureResetPasswordInfo" action="saveResetPasswordInfo.action" method="POST" cssClass="ajaxinlineform">
	<div><br><br></div>
...
<%-- 	<s:hidden name="hintQuestionFromDB" id="hintQuestionFromDB"></s:hidden> --%>
	...
	<s:select id="questionId" cssClass="required requiredselect editdisplayStar" onchange="javascript:setQuestionIdBeforeSave()" key="setup.user.hint.q" 
