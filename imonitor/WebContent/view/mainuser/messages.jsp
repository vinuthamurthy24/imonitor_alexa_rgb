...
<script>
		var messageMap =
		{
				...
				"setup.devices.VIA.title":"<s:text name='setup.devices.VIA.title' />",
				"setup.devices.Indoor.title":"<s:text name='setup.devices.Indoor.title' />",
				"setup.devices.Capability.title":"<s:text name='setup.devices.Capability.title' />", 
				"setup.devices.Filter.title":"<s:text name='setup.devices.Filter.title' />", 
				...
				"Energy.InstantPowerconsumption":"<s:text name='Energy.InstantPowerconsumption' />",
                 ...
                 "VIA":"<s:text name='VIA' />",
                 "HA_IF":"<s:text name='HA_IF' />",
                 "VIA_UNIT":"<s:text name='VIA_UNIT' />",
                 "DEV_ZWAVE_WALL_MOTE_QUAD":"<s:text name='DEV_ZWAVE_WALL_MOTE_QUAD' />",
                 "msg.imonitor.viadelete.0001":"<s:text name='msg.imonitor.viadelete.0001' />",
                 "msg.imonitor.slavedelete.0001":"<s:text name='msg.imonitor.slavedelete.0001' />",
                 "msg.imonitor.devicedelete.0000":"<s:text name='msg.imonitor.devicedelete.0000' />",
                 "setup.devices.Wallmote.title":"<s:text name='setup.devices.Wallmote.title' />",
                 "DEV_ZWAVE_FIB_KEYFOBE":"<s:text name='DEV_ZWAVE_FIB_KEYFOBE' />",
                 "DEV_ZWAVE_RGB":"<s:text name='DEV_ZWAVE_RGB' />",
                 "DEV_ZWAVE_VIRTUAL_SW":"<s:text name='DEV_ZWAVE_VIRTUAL_SW' />",
                 "setup.devices.VirtualSwitchConfiguration.title":"<s:text name='setup.devices.VirtualSwitchConfiguration.title' />",
