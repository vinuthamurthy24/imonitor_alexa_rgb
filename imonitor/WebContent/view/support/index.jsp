...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="" class="bodyclasssupportlogin">
	<div style="width:100%; height:80px;">
		...
		<h1 class="display">Welcome to iMonitor Support</h1>
					<s:form action="../imonitor/supportLogin.action" method="post" id="loginform">
			<div class="supportlogin">
			<div style="margin: 17px 0px 0px 589px;"><img src="<%=applicationName %>/resources/images/imsipl_logo.jpg" class="circular"/></div>
