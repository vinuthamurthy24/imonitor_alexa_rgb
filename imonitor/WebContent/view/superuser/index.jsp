		...
		<div class="body_container">
			<div class="body">
				...
				<div class="right_part">
					<form action="verifySuperUserLogin.action" method="post" id="loginform" namespace="/">
						<div class="login">
			...
			<%ActionContext.getContext().getSession().remove("message"); %>
							...
							<div class="name">
								 <input class="username" id="username" name="user.userId"
									type="text"  placeholder="SuperUser Id"/>
							</div>
							<div class="name">
