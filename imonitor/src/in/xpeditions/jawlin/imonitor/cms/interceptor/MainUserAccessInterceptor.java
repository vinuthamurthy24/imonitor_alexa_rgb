 ...
 *
 */
public class MainUserAccessInterceptor implements Interceptor {
  ...
  //      LogUtil.info("session user Id: "+ sessionAttributes.get("loginId"));
		...
		if(user.getRole().getName().compareTo(Constants.MAIN_USER) != 0){
