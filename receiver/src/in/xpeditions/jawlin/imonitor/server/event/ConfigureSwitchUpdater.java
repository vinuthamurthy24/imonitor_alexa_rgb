 ...
 *
 */
public class ConfigureSwitchUpdater extends EventUpdateHelper {
	 ...
	 * @throws Exception
	 */
	public Queue<KeyValuePair> updateConfigureSwitchSuccess(Queue<KeyValuePair> events)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public Queue<KeyValuePair> updateConfigureSwitchFail(Queue<KeyValuePair> events)
			throws Exception {
		Queue<KeyValuePair> queue = new LinkedList<KeyValuePair>();
		String xml = IMonitorUtil.convertQueueIntoXml(events);
		String serviceName = "commandIssueService";
