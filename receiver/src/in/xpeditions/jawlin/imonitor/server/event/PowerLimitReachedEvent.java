...
public class PowerLimitReachedEvent extends EventUpdateHelper {
	 ...
	 * @throws Exception
	 */
	public Queue<KeyValuePair> UpdatePowerLimitReachedSuccess(Queue<KeyValuePair> events)throws Exception {
	 ...
	 * @throws Exception
	 */
	public Queue<KeyValuePair> UpdatePowerLimitReachedFailed(Queue<KeyValuePair> events)throws Exception {
		Queue<KeyValuePair> queue = new LinkedList<KeyValuePair>();
		String xml = IMonitorUtil.convertQueueIntoXml(events);
		String serviceName = "commandIssueService";
