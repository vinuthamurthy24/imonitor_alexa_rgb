 ...
 *
 */
public class RoomThreeMotionDetectionListener implements MouseListener {
	...
	public void mouseClicked(MouseEvent arg0) {
		String deviceAlertMessage = MessageUtil.createDeviceAlertMessage(MessageUtil.macId + "-" +  Constants.ROOM3CAMERA, Constants.MOTION_DETECTED);
		try {
