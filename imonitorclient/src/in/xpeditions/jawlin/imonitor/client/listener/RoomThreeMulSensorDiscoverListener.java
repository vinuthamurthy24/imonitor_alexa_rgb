...
public class RoomThreeMulSensorDiscoverListener implements MouseListener {

	@Override
	public void mouseClicked(MouseEvent e) {
		String deviceDiscoveredMessage = MessageUtil.createDeviceDiscoveredMessage(Constants.ROOM3MUL, Constants.Z_WAVE_MULTI_SENSOR, "Model 1");
		try {
