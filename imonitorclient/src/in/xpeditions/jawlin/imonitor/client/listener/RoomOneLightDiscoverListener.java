 ...
 *
 */
public class RoomOneLightDiscoverListener implements MouseListener {
	...
	public void mouseClicked(MouseEvent arg0) {
		String deviceDiscoveredMessage = MessageUtil.createDeviceDiscoveredMessage(Constants.ROOM1BULB, Constants.Z_WAVE_SWITCH, "Model 1");
		try {
