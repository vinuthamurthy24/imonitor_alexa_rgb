 ...
 *
 */
public class RoomOneDimmerDiscoverListener implements MouseListener {
	...
	public void mouseClicked(MouseEvent arg0) {
		String deviceDiscoveredMessage = MessageUtil.createDeviceDiscoveredMessage(Constants.ROOM1DIMMER, Constants.Z_WAVE_DIMMER, "Model 1");
		try {
