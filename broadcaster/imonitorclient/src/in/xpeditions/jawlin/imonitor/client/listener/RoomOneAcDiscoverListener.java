 ...
 *
 */
public class RoomOneAcDiscoverListener implements MouseListener {
	...
	public void mouseClicked(MouseEvent arg0) {
		String deviceDiscoveredMessage = MessageUtil.createDeviceDiscoveredMessage(Constants.ROOM1AC, Constants.Z_WAVE_AC_EXTENDER, "Ac model");
		try {
