 ...
 *
 */
public class RoomTwoLightDiscoverListener implements MouseListener {
	...
	public void mouseClicked(MouseEvent arg0) {
		String deviceDiscoveredMessage = MessageUtil.createDeviceDiscoveredMessage(Constants.ROOM2BULB, Constants.Z_WAVE_SWITCH, "Model 1");
		try {
