...
public class RoomTwoPirSensorDiscoverListener implements MouseListener {

	@Override
	public void mouseClicked(MouseEvent arg0) {
		String deviceDiscoveredMessage = MessageUtil.createDeviceDiscoveredMessage(Constants.ROOM2PIR, Constants.Z_WAVE_PIR_SENSOR, "Model 1");
		try {
