...
public class SceneControllerRemoteAction implements ImonitorControllerAction
{
	...
	public String executeCommand(ActionModel actionModel) {
		...
		queue.add(new KeyValuePair(Constants.KN,""+"7"+";"+keyconfigObjects.get(12).getKeyCode()+";"+keyconfigObjects.get(12).getAction().getId() ));
		queue.add(new KeyValuePair(Constants.KN,""+"7"+";"+keyconfigObjects.get(13).getKeyCode()+";"+keyconfigObjects.get(13).getAction().getId() ));
		queue.add(new KeyValuePair(Constants.KN,""+"8"+";"+keyconfigObjects.get(14).getKeyCode()+";"+keyconfigObjects.get(14).getAction().getId() ));
		queue.add(new KeyValuePair(Constants.KN,""+"8"+";"+keyconfigObjects.get(15).getKeyCode()+";"+keyconfigObjects.get(15).getAction().getId() ));
