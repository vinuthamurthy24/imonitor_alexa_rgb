...
public class RGBColorPickerAction implements ImonitorControllerAction
{
	...
	public String executeCommand(ActionModel actionModel) {
		...
		String hexValue = (String) actionModel.getData();
		
		queue.add(new KeyValuePair(Constants.ZW_SWITCH_COLOR,hexValue));
