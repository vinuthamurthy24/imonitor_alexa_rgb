...
public class EnableAction implements ImonitorControllerAction {
	...
	public String executeCommand(ActionModel actionModel) {
		...
		//we are trying to enable camera so it must be disabled.
		...
		queue.add(new KeyValuePair(Constants.IPC_ENABLE_LIVE_STREAM, Constants.ENABLE));
	...
	public String executeSuccessResults(Queue<KeyValuePair> queue) {
		...
		if(deviceManager.updateDeviceEnableStatus(generatedDeviceId,"1"))
		{
	...
	public List<KeyValuePair> createImvgConfigParams(
		...
		keyValuePairs.add(new KeyValuePair(Constants.IPC_ENABLE_LIVE_STREAM,Constants.ENABLE));
