 ...
 *
 */
public class RetrieveTemperatureAction implements ImonitorControllerAction {
	...
	public String executeCommand(ActionModel actionModel) {
		...
		queue.add(new KeyValuePair(Constants.ZW_GET_TEMPERATURE_VALUE,"1"));
	...
	public String executeSuccessResults(Queue<KeyValuePair> queue) {
		...
		String commandParam = IMonitorUtil.commandId(queue, Constants.TEMPERATURE_VALUE);
