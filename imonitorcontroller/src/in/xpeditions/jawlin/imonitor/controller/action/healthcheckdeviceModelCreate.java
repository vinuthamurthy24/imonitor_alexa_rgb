...
public class healthcheckdeviceModelCreate implements ImonitorControllerAction {
	...
	public String executeCommand(ActionModel actionModel) {
		...
		queue.add(new KeyValuePair(Constants.CMD_ID,"CREATE_SCHEDULE"));
		...
		String scheduletime=(String)listforupdatehealth.get(0);
		queue.add(new KeyValuePair(Constants.SCHEDULE_SPECIFIC_SCHEDULE_TIME,"" +formatScheduleTime(scheduletime)));
		queue.add(new KeyValuePair("AD","" + ActionDeviceId +";SCAN_HMD=1"));
