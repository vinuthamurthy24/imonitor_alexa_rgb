...
public class changePasswordUser implements ImonitorControllerAction {
	...
	//	XStream stream = new XStream();
		...
		queue.add(new KeyValuePair(Constants.CMD_ID,Constants.MODIFY_MAINUSR));
		...
		queue.add(new KeyValuePair(Constants.MAIN_ID,user.getId()+""));
