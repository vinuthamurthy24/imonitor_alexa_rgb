...
public class ScheduleDeactivateAction implements ImonitorControllerAction {
	...
	//	Schedule schedule = (Schedule) this.actionModel.getData();
		String message = "msg.controller.schedules.0012";  //parishod changed the message format
	...
	public String executeFailureResults(Queue<KeyValuePair> queue) {
		...
		String tId = IMonitorUtil.commandId(queue, Constants.TRANSACTION_ID);
		IMonitorSession.remove(tId);
		String message = "msg.controller.schedules.0013" 
