...
public class AddUser implements ImonitorControllerAction {
	...
	public String executeCommand(ActionModel actionModel) {
		...
		//LogUtil.info("user---"+stream.toXML(user));
		GateWay gateway= (GateWay) actionModel.getData();
		//LogUtil.info("gateway---"+stream.toXML(gateway));
		Queue<KeyValuePair> queue = new LinkedList<KeyValuePair>();
		queue.add(new KeyValuePair(Constants.CMD_ID,Constants.CREATE_USR));
