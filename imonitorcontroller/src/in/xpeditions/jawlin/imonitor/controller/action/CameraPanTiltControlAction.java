 ...
 *
 */
public class CameraPanTiltControlAction implements ImonitorControllerAction {
	...
	public String executeCommand(ActionModel actionModel) {
		...
		// Modified by Naveen on Aug 27th 2014
		
		CameraConfiguration cameraConfiguration = (CameraConfiguration) device.getDeviceConfiguration();
		
		String paramName = Constants.IPC_CONTROL_PANTILT;
		String paramValue = cameraConfiguration.getControlPantilt();
		...
		//cameraConfiguration.setPantiltControl("1");
		queue.add(new KeyValuePair(Constants.IPC_PANTILT_CONTROL,"1"));
	...
	public String executeSuccessResults(Queue<KeyValuePair> queue) {
		...
		Device device = deviceManager.updatePanAndTilt(generatedDeviceId, gateWayId, cameraConfiguration);
