 ...
 *
 */
public class AcSwingControlAction implements ImonitorControllerAction {

	private ActionModel actionModel;
	private boolean resultExecuted=false;

	public AcSwingControlAction() {
	...
	public String executeCommand(ActionModel actionModel) {
		...
		queue.add(new KeyValuePair(Constants.ZXT_AC_SWING_CONTROL,acSwing));
...
//		}
		...
		Device deviceFromDeviceManager = deviceManager.updateFanModesOfDeviceByGeneratedId(generatedDeviceId, macId,acConfiguration.getAcSwing(),0);
