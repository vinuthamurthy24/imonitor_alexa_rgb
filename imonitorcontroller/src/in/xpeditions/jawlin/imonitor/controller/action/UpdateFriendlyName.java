...
public class UpdateFriendlyName implements ImonitorControllerAction {
	...
	//	long iconId = device.getIcon().getId();
		...
		String generatedDeviceId = deviceFromID.getGeneratedDeviceId();
		...
		queue.add(new KeyValuePair(Constants.IMVG_ID,deviceFromID.getGateWay().getMacId()));
		...
		queue.add(new KeyValuePair(Constants.FRIENDLY_DEVICE_NAME,friendlyName ));
