...
public class RemoveIndoorUnitAction implements ImonitorControllerAction
{
	...
	public String executeCommand(ActionModel actionModel) {
		...
		Device deviceFromDb=deviceManager.getDevice(device.getId());
		...
		queue.add(new KeyValuePair(Constants.CMD_ID, Constants.REMOVE_IDU));
