 ...
 *
 */
public class AllArmAction implements ImonitorControllerAction {
	...
	public String executeCommand(ActionModel actionModel) {
		...
		queue.add(new KeyValuePair(Constants.CMD_ID, Constants.ARM_DEVICES));
	...
	public String executeFailureResults(Queue<KeyValuePair> queue) {
		//POPULATE APPROPRIATE DEVICES ON GETTING ARM_DEVICES_PROGRESS_FAIL
