...
public class ScenarioCreateAction implements ImonitorControllerAction {
	...
	public String executeCommand(ActionModel actionModel) {
		...
		queue.add(new KeyValuePair(Constants.CMD_ID, Constants.CREATE_SCENARIO));
...
//		If success, let's pass it. We already saved the data.
		...
		IMonitorSession.remove(tId);
		//Scenario scenario = (Scenario) this.actionModel.getData();
		String message = "msg.controller.scenarios.0006";
		this.actionModel.setMessage(message);
		this.resultExecuted = true;
		return null;
	}
